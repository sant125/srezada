...
- **WH1 multi-cliente**: SLO por cliente vale mais que uptime genérico; falha do provedor debita do meu budget, então o SLO prometido tem que caber no SLA da AWS/GCP
